        ...
        if (Object.keys(self._languages).includes(material.language)) {
            ...
            if (material.author && typeof material.author === 'string') {
                ...
                speakers = material.author
                            .split(',')
                            .map(author => ({
                                speaker_id:   this._translateString(author.trim()),
                                speaker_name: this._translateString(author.trim())
                            }));
            ...
            const options = Object.assign({ }, self._options, {
                manifest: {
                    ...
                    metadata: {
                        ...
                        title: this._translateString(material.title),
                        speakers
                    },

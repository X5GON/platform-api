...
module.exports = function (pg, logger) {
    ...
    /**
     * @apiIgnore The API is meant to be be used in combination with the on-premise snippet version.
     * @api {GET} /api/v1/snippet/tracker Sets the user cookie if repository uses the on-premise
     * snippet version.
    ...
    /**
     * @api {GET} /api/v1/snippet/log Send user activity snippet information. All parameters should
    ...
    /**
     * @apiIgnore The API is meant to be used through the `/api/v1/snippet/log`
     * @api {GET} /api/v1/snippet/log/development Send user activity snippet information FOR TESTING.
    ...
    /**
     * @apiIgnore The API is meant to be used through the `/api/v1/snippet/log`
     * @api {GET} /api/v1/snippet/log/production Send user activity snippet information FOR PRODUCTION.
     * All parameters should be encoded by the `encodeURIComponent` function.
    ...
    /**
     * @api {GET} /api/v1/snippet/:version/x5gon-log(.min)?.js Get the snippet library directly from the server.
     ...
     *      curl -i https://platform.x5gon.org/api/v1/snippet/latest/x5gon-log.min.js
     */

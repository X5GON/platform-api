...
let commands = [
    'CREATE TABLE IF NOT EXISTS client_activity (id serial PRIMARY KEY, uuid varchar NOT NULL, provider varchar NOT NULL, url varchar NOT NULL, referrer varchar NOT NULL, visitedOn timestamp with time zone);',

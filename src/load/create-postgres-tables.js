...
let commands = [
    ...
    `CREATE TABLE IF NOT EXISTS oer_materials_partial (id serial PRIMARY KEY,
        title varchar, description varchar, providerUri varchar,
        materialUrl varchar, author varchar, language varchar,
        dateCreated timestamp with time zone, dateRetrieved timestamp with time zone,
        type jsonb, providerMetadata jsonb, materialMetadata jsonb);`,
